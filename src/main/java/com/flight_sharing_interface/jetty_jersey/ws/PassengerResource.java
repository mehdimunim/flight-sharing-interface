...
public class PassengerResource {
	...
	public List<Flight> getBookedFlights() {
		...
		f1.setDepartureDate(LocalDate.of(2020, Month.MAY, 28));
		f1.setDepartureDate(LocalDate.of(2020, Month.MAY, 28));
		f1.price = 100;
		...
		Pilot p1 = new Pilot("Dansokho", "Mamadou", "eidd flight first shared flight");
		f1.pilot = p1;

		f2.departure_aerodrome = "London";
		f2.setDepartureDate(LocalDate.of(2020, Month.MAY, 25));
		f2.setArrivalDate(LocalDate.of(2020, Month.MAY, 25));
		f2.price = 100;
		...
		Pilot p2 = new Pilot("Boudalil", "Hassna", "eidd flight first shared flight");
		f2.pilot = p2;

		f3.departure_aerodrome = "London";
		f3.setDepartureDate(LocalDate.of(2020, Month.MAY, 20));
		f3.setArrivalDate(LocalDate.of(2020, Month.MAY, 20));
		f3.price = 100;
		...
		Pilot p3 = new Pilot("Munim", "Mehdi", "eidd flight first shared flight");
		f3.pilot = p3;
